...
🔍 Manual & Automation Testing | ☁️ Cloud-Aware QA  

Bachelor of Electronics and Instrumentation graduate from Universitas Gadjah Mada with hands-on experience in **Software Quality Assurance**, including **functional testing, API testing, regression testing, and test automation** in real production systems (Fintech & E-Commerce).
